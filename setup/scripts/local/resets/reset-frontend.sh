...
bash template project run web rm -rf node_modules/
echo ":: ----- Removing from mobile front-end." 
bash template project run mobile rm -rf node_modules/

# Remove dist/ folder 
echo ":: Removing dist/ folders from front-ends (if there are any)."
echo ":: ----- Removing from web front-end."
bash template project run web rm -rf dist/
echo ":: ----- Removing from mobile front-end." 
bash template project run mobile rm -rf  dist/